...
import ArbolUsuariospdf from '../ArbolesMerkle/ArbolUsuarios.pdf'
import '../Inicio.css'
import axios from 'axios'
function ArbolUsuarios() {
    ...
    if (existe === true) {return(
        ...
        if (loading === false) {
            return (
                <div className="General">
                    <embed src={ArbolUsuariospdf} type='application/pdf' width="100%" height="625"  /> 
                </div>
            )
        }else{
            return(
